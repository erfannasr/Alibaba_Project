          ...
          <div className="mb-2 h-full pb-6 ">
            ...
            >
              <SwiperSlide className="cursor-pointer">
                <img
                  src="https://cdn.alibaba.ir/cms/uploads/Ad_Hoc_Requests_Refund_Penalty_Cardview_Banner_Desktop_02_06_19_f3b9e45af4.png"
                  alt=""
              ...
              <SwiperSlide className="cursor-pointer">
                <img
                  src="https://cdn.alibaba.ir/cms/uploads/Comic_Book_Card_View_Desktop_74577d9431.png"
                  alt=""
              ...
              <SwiperSlide className="cursor-pointer">
                <img
                  src="https://cdn.alibaba.ir/cms/uploads/Product_Marketing_Internet_Call_Cardview_Banner_Desktop_02_08_29_c9dc76e886.jpg"
                  alt=""
                  className="w-[592px] h-[224px] rounded-[8px]"
                />
              </SwiperSlide>
              <SwiperSlide className="cursor-pointer">
                <img
                  src="https://cdn.alibaba.ir/cms/uploads/Eghamatghah_Cardview_Banner_Desktop_02_05_18_5_5d266cd132.jpg"
                  alt=""
                  className="w-[592px] h-[224px] rounded-[8px]"
                />
              </SwiperSlide>
