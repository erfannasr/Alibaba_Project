        ...
        <div className="w-[1200px]  relative mb-[2rem]  z-20 py-[0.5rem] pb-[2.5rem] px-[2.25rem]  bg-[#fff] rounded-lg border-[#0000001f] border-[1px]  shadow-[0px_1px_1px_-1px_rgba(0,_0,_0,_.08)]">
          <div className="mb-[1.5rem] border-b-[1px] items-center">
            <ul className="flex relative justify-evenly max-w-full p-0 font-medium ml-[-1px] mt-2">
              ...
              <li className="px-[1.5rem] flex flex-col items-center text-[#0033db]">
                ...
                <span className="border-b-[3px] rounded-[8px] border-[#0033db] pb-2">پرواز داخلی</span>
              </li>
              </Link>
              <Link to={"/iranout"}>
          ...
          <div className="flex flex-col">
            <div className="mb-6">
              ...
              {isOpenSide && (
                <ul className="absolute mt-2 right-17  z-50 bg-[#fff] p-0 m-0 rounded-lg w-[126px] shadow-[0px_6px_10px_0px_rgba(0,0,0,0.22)]">
            ...
            <div className=" flex h-[48px] justify-between items-stretch">
              <div className="relative flex w-[471px] border-[#BEC6CC] border-[1px] p-[5px] rounded-[8px] justify-evenly  items-center">
                ...
                {isOpenOrigin && (
                  <ul className="absolute overflow-y-scroll right-0 top-[50px]  bg-[#fff] p-0 m-0 rounded-lg w-[222px] h-[300px] shadow-[0px_6px_10px_0px_rgba(0,0,0,0.22)]">
                    <li className="bg-[#F8FAFB] mt-1  pr-2 w-full text-[13px] text-[#6c7680]">
                      پرتردد
                    </li>
                    <li className="py-3 flex px-3 cursor-pointer  h-[56px] hover:bg-[#F2F9FF] rounded-[8px] ">
                      ...
                      <span className="text-[14px]">تهران</span>
                    </li>
                    ...
                    <li className="py-3 flex h-[56px] px-3 cursor-pointer hover:bg-[#F2F9FF] rounded-[8px]">
                      ...
                      <span className="text-[14px]">اهواز</span>
                    </li>
                    ...
                    <li className="py-3 px-3 flex h-[56px] cursor-pointer hover:bg-[#F2F9FF] rounded-[8px]">
                      ...
                      <span className="text-[14px]">شیراز</span>
                    </li>
                    ...
                    <li className="py-3 flex px-3 h-[56px] cursor-pointer hover:bg-[#F2F9FF] rounded-[8px]">
                      ...
                      <span className="text-[14px]">مشهد</span>
                    </li>
                    <hr className="m-0 border-0 border-solid border-[#00000010] border-b-17  mr-[5px] ml-[5px]" />
                    ...
                    <li className="py-3 flex px-3 h-[56px] cursor-pointer hover:bg-[#F2F9FF] rounded-[8px]">
                      ...
                      <span className="text-[14px]">بندر عباس</span>
                    </li>
                    <hr className="m-0 border-0 border-solid border-[#00000010] border-b-17  mr-[5px] ml-[5px]" />
                    ...
                    <li className="py-3 flex px-3 h-[56px] cursor-pointer hover:bg-[#F2F9FF] rounded-[8px]">
                      ...
                      <span className="text-[14px]">اصفهان</span>
                    </li>
                    <hr className="m-0 border-0 border-solid border-[#00000010] border-b-17  mr-[5px] ml-[5px]" />
                    ...
                    <li className="py-3 flex px-3 h-[56px] cursor-pointer hover:bg-[#F2F9FF] rounded-[8px]">
                      ...
                      <span className="text-[14px]">تبریز</span>
                    </li>
                    <hr className="m-0 border-0 border-solid border-[#00000010] border-b-17  mr-[5px] ml-[5px]" />
                    ...
                    <li className="py-3 flex px-3 h-[56px] cursor-pointer hover:bg-[#F2F9FF] rounded-[8px]">
                      ...
                      <span className="text-[14px]">کیش</span>
                    </li>
                  </ul>
                )}
                ...
                {isOpenDestination && (
                  <ul className="absolute overflow-y-scroll top-[50px] left-1  bg-[#fff] p-0 m-0 rounded-lg w-[222px] h-[300px] shadow-[0px_6px_10px_0px_rgba(0,0,0,0.22)]">
                    <li className="bg-[#F8FAFB] mt-1  pr-2 w-full text-[13px] text-[#6c7680]">
                      پرتردد
                    </li>
                    <li className="py-3 flex px-3 cursor-pointer  h-[56px] hover:bg-[#F2F9FF] rounded-[8px] ">
                  ...
                  <ul className="absolute top-[50px] h-[172px] right-0 bg-[#fff] p-0 m-0 rounded-lg w-[300px] shadow-[0px_6px_10px_0px_rgba(0,0,0,0.22)]">
                    <li className="flex justify-between py-3 px-3 cursor-pointer hover:bg-[#F8FAFB] rounded-[8px] ">
                      ...
                      <div className="flex justify-between items-center">
                        <button   onClick={e => e.preventDefault()} className="bg-[#0077db] text-[#fff] ml-[12px] py-1 px-1 flex items-center justify-center rounded-[7px]">
                          <span>
                            <svg
                              viewBox="0 0 24 24"
                              width="16px"
                        ...
                        <button onClick={e => e.preventDefault()} className="bg-[#0077db] opacity-[0.5] text-[#fff] py-1 px-1 flex items-center justify-center rounded-[7px]">
                          <svg
                            viewBox="0 0 24 24"
                            width="16px"
                            height="16px"
