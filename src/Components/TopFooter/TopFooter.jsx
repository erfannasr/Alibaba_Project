...
function TopFooter() {
  return (
    <div>
      ...
      <div className="w-full border-t-[1px] flex justify-center items-center ">
        <div className="w-[1200px] pt-[32px] pb-[64px] relative">
          <ul className=" flex justify-between">
            <li className="flex items-center">
              ...
              <div className="flex flex-col mr-3">
                <span className="font-bold ">رتبه یک سفر</span>
                <p className="text-[#6c7680] text-[14px] mt-2">
                  معتبرترین عرضه‌کننده محصولات <br /> گردشگری در ایران
                </p>
              </div>
            </li>
            <li className="flex items-center mr-5">
              ...
              />
              <div className="flex flex-col mr-3">
                <span className="font-bold ">همسفر هر سفر</span>
                <p className="text-[#6c7680] text-[14px] mt-2">
                  ارائه تمامی خدمات سفر (پرواز، قطار، <br /> اتوبوس، هتل و تور)
                </p>
              </div>
            </li>
            <li className="flex items-center">
              ...
              />
              <div className="flex flex-col mr-3">
                <span className="font-bold ">همسفر همه لحظات سفر</span>
                <p className="text-[#6c7680] text-[14px] mt-2">
                  پشتیبانی و همراهی ۲۴ ساعته در تمامی <br /> مراحل سفر
                </p>
              </div>
            </li>
          </ul>
